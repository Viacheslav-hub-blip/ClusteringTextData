...
class OutputBuilder:
    """Assign final stable labels back to input comments."""
    ...
    def build(
        ...
        """Build output records for all input comments."""
        ...
        for comment_id, prototype_id in comment_to_prototype.items():
            ...
            parent_cluster = parent_clusters_by_id[specific_cluster.parent_cluster_id]
            outputs.append(
                OutputRecord(
